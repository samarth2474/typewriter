export const trainingTimesAndDiffucilties = [
	{time: 60,
        diffucility: "easy" },
        {time: 60,
        diffucility: "medium" },
...
// text samples that app draws from randomly 
export const textSamples = {
	"easy": [
  "You know what I've noticed? Nobody panics when things go 'according to plan'. Even if the plan is horrifying. If, tomorrow, I tell the press that, like, a gang banger will get shot, or a truckload of soldiers will be blown up, nobody panics, because it's all 'part of the plan'. But when I say that one little old mayor will die, well then everyone loses their minds!",

  "I've always believed in numbers, in equations, in logic and reason.But after a lifetime of such pursuits: I ask What truly is logic? Who decides reason? My quest has taken me to the physical, the metaphysical, the delusional, and back.",
  ...
  "A portion of the army that had retreated from Ticonderoga was camped on the flats near the town, and Robert and Tayoga walked swiftly toward the tents. It was a much more silent force, British and American, than that which had gone forth not so very long ago to what seemed certain victory. Officers and men were angry. They felt that they had been beaten when there was no reason why they should have been defeated. ",
...
"medium": [
  ...
  "On the arrival of Lewis and Clarke at the mouth of the Columbia, in 1806, the new language, from the sentences given by them, had evidently attained some form. It was with the arrival of Astor's party, however, that the Jargon received its principal impulse. Many more words of English were then brought in, and for the first time the French, or rather the Canadian and Missouri patois of the French, was introduced.",
],
"hard": [
  "A neutron star is the collapsed core of a large star which before collapse had a total of between 10 and 29 solar masses. Neutron stars are the smallest and densest stars, not counting hypothetical quark stars and strange stars. Typically, neutron stars have a radius on the order of 10 kilometres and a mass between 1.4 and 3 solar masses. They result from the supernova explosion of a massive star, combined with gravitational collapse, that compresses the core past the white dwarf star density to that of atomic nuclei.",
