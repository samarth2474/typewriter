...
class SingleTest extends Component {
  ...
  changeTimeHandler(){
    ...
    // console.log(this.props.location.state)
		return (
        <div>
            {!dataShown && !timeChoiceFilled && <ChooseTimeAndDiff handleApply={this.applyChange} /> }
            <div className="testArea">
                {!dataShown && timeChoiceFilled && <Tester testHandler={this.testHandler}
                timeChoice={this.state.timeChoice} training={false} diffu={this.state.diffu} changeTimeHandler={this.changeTimeHandler} />}
                {dataShown && timeChoiceFilled }
